...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002303789139'))  # Notification of those who verify will be sent to your channel
...
DEENDAYAL_VERIFIED_LOG = ('-1002303789139'))  # Log channel id (make sure bot is admin)
